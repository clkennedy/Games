...
import static com.atkinson.game.content.Star.sHeight;
...
public class DoubleFire extends PowerUp{
    ...
    public void apply() {
        ...
        defaultSpeed = (this._player.getReloadSpeed());
        
        this._player.setReloadSpeed(defaultSpeed / modifier);
        this.applied = true;
    }

    @Override
    public void end() {
        this._player.setReloadSpeed(defaultSpeed);
